...
- отключение: `houses.status = 'disconnected'`, `houses.disconnected_from` — первый месяц без начислений; история платежей, прежний долг и касса сохраняются, дом остаётся в отчётности;
