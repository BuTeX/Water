...
В админке в разделе «Дома» у каждого дома есть отдельная защищенная страница переписки. На ней объединены сообщения Telegram и MAX, явно показаны направление, получатель, текст, тип вложения и время. В журнал попадают успешно отправленные сообщения ботов и входящие сообщения жителей.
